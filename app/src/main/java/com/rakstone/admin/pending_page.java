...
public class pending_page extends AppCompatActivity {

    LinearLayout contentLayout;
    ImageView order_myprofile, order_home,pending_home;
    ArrayList<HashMap<String, String>> orderList = new ArrayList<>();
    String baseUrl = "http://172.20.10.10/apps/admin_pending_history.php";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pending_home=findViewById(R.id.pending_home);

        pending_home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(pending_page.this, home_page.class));
            }
        });
...
//        String url = "http://192.168.1.102/apps/admin_order_history.php"; // শুধু সব অর্ডার আনবে
    ...
    private void inflateOrders() {
        ...
        for (HashMap<String, String> order : orderList) {
            // শুধু pending orders show করব
            String history = order.get("history").toLowerCase();
            if (!history.equals("pending")) continue;
            ...
            // Details button সবগুলোর জন্য yellow
            details.setText("Details");
            details.setBackgroundColor(getResources().getColor(android.R.color.holo_orange_light));
            ...
            // Delivery button click listener
            delivery.setOnClickListener(v -> updateOrderToDelivery(order.get("id")));

            contentLayout.addView(view);
        }
    }

    private void updateOrderToDelivery(String orderId) {
